...
module.exports = angular.module('klaxon', []).factory('Alert', [
  '$rootScope', '$timeout', function($rootScope, $timeout) {
    ...
    return Alert = (function() {
      ...
      Alert.prototype.click = function($event) {
        if ($event != null) {
      ...
      Alert.prototype.add = function() {
        ...
        this.index = Alert.all.length;
        if (this.key && Alert.all.some((function(_this) {
          return function(alert) {
            return alert.key === _this.key;
          };
        })(this))) {
          Alert.all = Alert.all.map((function(_this) {
            return function(alert) {
      ...
      Alert.prototype.close = function($event) {
        ...
        return Alert.all.splice(this.index, 1);
      };
